...
We can control two parameters, <p><code>spatial_radius</code> and <code>color_radius</code></p>. The input is a picture and output is a picture after doing meanshift.
# Method #
## Mean Shift ##
